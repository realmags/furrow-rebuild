...
const accordionIds = [
  {
    ...
    results: ["Creative Development", "Writing", "Storyboards"],
  },
  {
    id: 1,
  ...
  },
  {
    ...
    results: ["Color Correction", "Offline Editing", "Online Editing"],
  },
  {
    id: 3,
    title: "Audio Post-Production",
    results: ["Sound Design", "Music and SFX", "Sound Mix"],
  },
];
...
function Accordion({ details, expanded, setExpanded, onCursor }) {
  ...
  return (
    <>
      ...
      >
        {details.results.map((result, key) => (
